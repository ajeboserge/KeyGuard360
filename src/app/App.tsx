...
export default function App() {
  ...
  const handleLogin = (username: string, password: string) => {
    ...
    toast.success(`Welcome back, ${username}!`, {
      description: "Successfully authenticated via AWS Cognito (Mock)",
    });
  };
  ...
  return (
    <div className="min-h-screen bg-background flex">
      <Toaster />
      {/* Sidebar */}
      <aside className={`${sidebarOpen ? 'w-64' : 'w-0'} transition-all duration-300 border-r bg-card flex-shrink-0 overflow-hidden`}>
            ...
            <div className="bg-accent rounded-lg p-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground truncate">admin@keyguard360.com</p>
                </div>
              </div>
            </div>
          </div>
